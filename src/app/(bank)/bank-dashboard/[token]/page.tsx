			...
			<div className='min-h-screen flex justify-center items-center'>
				...
				<main className='max-w-7xl mx-auto  py-6 sm:px-6 lg:px-8'>
					<div className='px-4 py-6 sm:px-0 w-full'>
						<Card className='bg-white/5 backdrop-blur-sm w-[40rem] border-primary border-2 mx-auto'>
							<CardHeader>
								...
								<Link href={'/bank-account'} className='bg-primary px-4 py2 rounded-3xl w-24'>Go Back</Link>
							</CardHeader>
							<CardContent>
								<dl className='grid grid-cols-1 gap-x-4 gap-y-6 sm:grid-cols-2'>
									<div className='sm:col-span-1'>
										<dt className='text-sm font-medium text-slate-200'>Name:</dt>
										<dd className='mt-1 text-lg font-bold text-primary'>{data.Name}</dd>
									</div>
									<div className='sm:col-span-1'>
									...
									<div className='sm:col-span-1'>
										<dt className='text-sm font-medium text-slate-200'>Email:</dt>
										<dd className='mt-1 text-lg font-bold text-primary'>{data.Email}</dd>
									</div>
									<div className='sm:col-span-1'>
										<dt className='text-sm font-medium text-slate-200'>
											Balance:
